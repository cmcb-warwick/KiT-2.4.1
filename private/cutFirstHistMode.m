...
if doHistogram
    ...
    [~,maxBinIdx] = max(counts(1:end-1));
    maxBinValue = bins(maxBinIdx + 1);


    % continuous histogram
    [counts,bins,sp] = jdhistogram(data,'smooth');
    nBins = length(bins);
