...
% Modified by A. Daniyan (c) November 2022
...
function updateControls(opts)
  ...
  if isfield(opts,'wavelet')
      ...
      hs.wletLevelThresh.String = "0";
      hs.wletLevelAdapt.Value = 0;
      hs.wletNumLevels.String = "0";
      hs.wletLocalMAD.String = "0";
      hs.wletBackSub.String = "0";
      hs.wletMinLevel.String = "0";
  end
...
function updateJobset()
  ...
  if handles.chromaticShift.Value
    ...
    result = getChromaticShiftResults(chrShift, opts.coordSystemChannel);
...
function cellResult = getChromaticShiftResults(chrShift,coordSysChan)
  ...
  for i = 1:3
    for j = 1:3
      ...
      if chrShift.filtering
         mS = chrsFilterSpots(mS,'neighbourFilter',neighFilt,...
             'intensityFilter',intFilt,'regionFilter',regFilt, ...
              'revert',1,'referenceChan',coordSysChan);
      end
      [result,~] = chrsCalculateChromaticShift(mS,[i j],...
          'filtered',chrShift.filtering,'interphaseToMetaphase',isfield(chrShift,'interphase'));
