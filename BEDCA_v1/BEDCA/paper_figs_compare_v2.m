function paper_figs_compare_v2(exptnum,runtreatments,server,options)
% paper_figs_compare_v2(exptnum,runtreatments,server,options)
%
...
% options.raw  Plot raw delta3D
  % Plotting control:
  % options.xmax, options.xlim [xmin xmax]
  %
  %
...
% From EuclDist_Driver. Loads Filenames and TreatmentLib
ExptData_list
