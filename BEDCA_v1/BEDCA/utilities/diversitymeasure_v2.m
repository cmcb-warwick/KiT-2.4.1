...
if length(cels)<300
    disp(' ')
    disp('*********** WARNING: Fewer than 300 KT. Algorithm performance poor especially for distances < 50nm ***********');
    disp(' ')
end
...
if 5*SI>1
    disp(' ')
    disp('*********** WARNING: Effective number of cells is <5. Biological variation will not be averaged out, so estimates are unreliable. ***********');
    disp(' ')
end
