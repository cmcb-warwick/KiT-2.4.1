function paper_figs(exptnum,runtreatment,nam,server,options)
% paper_figs(exptnum,runtreatment,nam,server,options)
%
...
%if ~isempty(strfind(lower(runtreatment),'untreated'))
%treatnam='untreated';
%else
treatnam='DMSO';
%end
